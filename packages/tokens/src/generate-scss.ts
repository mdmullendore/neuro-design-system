// Converts the @neuro/tokens TS values (color, typography, motion) into the
// generated _tokens.scss CSS custom properties consumed by the design system's
// Sass Modules. Run via `npm run tokens:build` whenever a token file changes.
...
const lines = [
  "// Generated by @neuro/tokens — do not hand-edit.",
  "// Run `npm run tokens:build` after changing packages/tokens/src/*.ts.",
  "",
  ":root {",
...
const outPath = fileURLToPath(
  new URL("../../design-system/src/neurotransmitters/_tokens.scss", import.meta.url),
);
